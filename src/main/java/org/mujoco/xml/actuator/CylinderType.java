    ...
    implements Cloneable, Copyable, PartialCopyable
{
        ...
        implements Buildable
    {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withName(final String name) {
            super.withName(name);
            return this;
        }
         ...
         */
        @Override
        public CylinderType.Builder<_B> withClazz(final String clazz) {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withJoint(final String joint) {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withJointinparent(final String jointinparent) {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withSite(final String site) {
            super.withSite(site);
            return this;
        }
         ...
         */
        @Override
        public CylinderType.Builder<_B> withTendon(final String tendon) {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withCranksite(final String cranksite) {
         ...
         */
        @Override
        public CylinderType.Builder<_B> withSlidersite(final String slidersite) {
        ...
        public CylinderType build() {
            if (_storedValue == null) {
                ...
                return ((CylinderType) _storedValue);
            }
        }

...
public class FixedType implements Cloneable, Copyable, PartialCopyable
{
    ...
    /**
     * Instantiates a FixedType copying the state of another FixedType
     * 
     * @param _other
     *     The original FixedType from which to copy state.
     */
    public FixedType(final FixedType _other) {
     ...
     *     The original FixedType from which to copy state.
     */
    public FixedType(final FixedType _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    ...
    public FixedType withVetoableChangeListener(final VetoableChangeListener vetoableChangeListener) {
    ...
    public FixedType withPropertyChangeListener(final PropertyChangeListener propertyChangeListener) {
    ...
    public FixedType clone() {
        final FixedType _newObject;
        try {
            _newObject = ((FixedType) super.clone());
    ...
    @Override
    public FixedType createCopy(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final FixedType _newObject;
        try {
            _newObject = ((FixedType) super.clone());
        } catch (CloneNotSupportedException e) {
    ...
    @Override
    public FixedType copyExcept(final PropertyTree _propertyTree) {
        return createCopy(_propertyTree, PropertyTreeUse.EXCLUDE);
    }

    @Override
    public FixedType copyOnly(final PropertyTree _propertyTree) {
     ...
     */
    public<_B >void copyTo(final FixedType.Builder<_B> _other) {
    ...
    public<_B >FixedType.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new FixedType.Builder<_B>(_parentBuilder, this, true);
    }

    public FixedType.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static FixedType.Builder<Void> builder() {
        return new FixedType.Builder<Void>(null, null, false);
    }

    public static<_B >FixedType.Builder<_B> copyOf(final FixedType _other) {
        final FixedType.Builder<_B> _newBuilder = new FixedType.Builder<_B>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final FixedType.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final PropertyTree namePropertyTree = ((_propertyTree == null)?null:_propertyTree.get("name"));
        if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)?(namePropertyTree!= null):((namePropertyTree == null)||(!namePropertyTree.isLeaf())))) {
            _other.name = this.name;
        }
    ...
    public<_B >FixedType.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new FixedType.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public FixedType.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >FixedType.Builder<_B> copyOf(final FixedType _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final FixedType.Builder<_B> _newBuilder = new FixedType.Builder<_B>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static FixedType.Builder<Void> copyExcept(final FixedType _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static FixedType.Builder<Void> copyOnly(final FixedType _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.INCLUDE);
    }

    public FixedType visit(final PropertyVisitor _visitor_) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final FixedType _storedValue;
        private String name;
        ...
        public Builder(final _B _parentBuilder, final FixedType _other, final boolean _copy) {
        ...
        public Builder(final _B _parentBuilder, final FixedType _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends FixedType >_P init(final _P _product) {
         ...
         */
        public FixedType.Builder<_B> withName(final String name) {
            this.name = name;
            return this;
        }
         ...
         */
        public FixedType.Builder<_B> withClazz(final String clazz) {
            this.clazz = clazz;
            return this;
        }
         ...
         */
        public FixedType.Builder<_B> withGroup(final Integer group) {
            this.group = group;
            return this;
        }
         ...
         */
        public FixedType.Builder<_B> withLimited(final Boolean limited) {
         ...
         */
        public FixedType.Builder<_B> withRange(final String range) {
            this.range = range;
            return this;
        }
         ...
         */
        public FixedType.Builder<_B> withSolimplimit(final String solimplimit) {
         ...
         */
        public FixedType.Builder<_B> withSolreflimit(final String solreflimit) {
         ...
         */
        public FixedType.Builder<_B> withSolimpfriction(final String solimpfriction) {
         ...
         */
        public FixedType.Builder<_B> withSolreffriction(final String solreffriction) {
         ...
         */
        public FixedType.Builder<_B> withMargin(final BigDecimal margin) {
            this.margin = margin;
            return this;
        }
         ...
         */
        public FixedType.Builder<_B> withFrictionloss(final BigDecimal frictionloss) {
         ...
         */
        public FixedType.Builder<_B> withSpringlength(final BigDecimal springlength) {
         ...
         */
        public FixedType.Builder<_B> withStiffness(final BigDecimal stiffness) {
         ...
         */
        public FixedType.Builder<_B> withDamping(final BigDecimal damping) {
         ...
         */
        public FixedType.Builder<_B> withUser(final String user) {
            this.user = user;
            return this;
        }
        ...
        public FixedType build() {
            if (_storedValue == null) {
                return this.init(new FixedType());
            } else {
                return ((FixedType) _storedValue);
            }
        }

        public FixedType.Builder<_B> copyOf(final FixedType _other) {
            _other.copyTo(this);
            return this;
        }

        public FixedType.Builder<_B> copyOf(final FixedType.Builder _other) {
    ...
    public static class Select
        extends FixedType.Selector<FixedType.Select, Void>
    {
        ...
        public static FixedType.Select _root() {
            return new FixedType.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> name = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> clazz = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> group = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> limited = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> range = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solimplimit = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solreflimit = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solimpfriction = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solreffriction = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> margin = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> frictionloss = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> springlength = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> stiffness = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> damping = null;
        private com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> user = null;
        ...
        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> name() {
            return ((this.name == null)?this.name = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "name"):this.name);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> clazz() {
            return ((this.clazz == null)?this.clazz = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "clazz"):this.clazz);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> group() {
            return ((this.group == null)?this.group = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "group"):this.group);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> limited() {
            return ((this.limited == null)?this.limited = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "limited"):this.limited);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> range() {
            return ((this.range == null)?this.range = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "range"):this.range);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solimplimit() {
            return ((this.solimplimit == null)?this.solimplimit = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "solimplimit"):this.solimplimit);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solreflimit() {
            return ((this.solreflimit == null)?this.solreflimit = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "solreflimit"):this.solreflimit);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solimpfriction() {
            return ((this.solimpfriction == null)?this.solimpfriction = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "solimpfriction"):this.solimpfriction);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> solreffriction() {
            return ((this.solreffriction == null)?this.solreffriction = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "solreffriction"):this.solreffriction);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> margin() {
            return ((this.margin == null)?this.margin = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "margin"):this.margin);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> frictionloss() {
            return ((this.frictionloss == null)?this.frictionloss = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "frictionloss"):this.frictionloss);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> springlength() {
            return ((this.springlength == null)?this.springlength = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "springlength"):this.springlength);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> stiffness() {
            return ((this.stiffness == null)?this.stiffness = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "stiffness"):this.stiffness);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> damping() {
            return ((this.damping == null)?this.damping = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "damping"):this.damping);
        }

        public com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>> user() {
            return ((this.user == null)?this.user = new com.kscs.util.jaxb.Selector<TRoot, FixedType.Selector<TRoot, TParent>>(this._root, this, "user"):this.user);
        }

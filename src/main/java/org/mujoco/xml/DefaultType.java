        ...
        implements Buildable
    {
        ...
        public DefaultType.Builder<_B> addMesh(final Iterable<? extends MeshType> mesh_) {
            if (mesh_!= null) {
                ...
                for (MeshType _item: mesh_) {
                    this.meshOrMaterialOrJoint.add(new MeshType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addMaterial(final Iterable<? extends MaterialType> material_) {
            if (material_!= null) {
                ...
                for (MaterialType _item: material_) {
                    this.meshOrMaterialOrJoint.add(new MaterialType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addJoint(final Iterable<? extends JointType> joint_) {
            if (joint_!= null) {
                ...
                for (JointType _item: joint_) {
                    this.meshOrMaterialOrJoint.add(new JointType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addGeom(final Iterable<? extends GeomType> geom_) {
            if (geom_!= null) {
                ...
                for (GeomType _item: geom_) {
                    this.meshOrMaterialOrJoint.add(new GeomType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addSite(final Iterable<? extends SiteType> site_) {
            if (site_!= null) {
                ...
                for (SiteType _item: site_) {
                    this.meshOrMaterialOrJoint.add(new SiteType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addCamera(final Iterable<? extends CameraType> camera_) {
            if (camera_!= null) {
                ...
                for (CameraType _item: camera_) {
                    this.meshOrMaterialOrJoint.add(new CameraType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addLight(final Iterable<? extends LightType> light_) {
            if (light_!= null) {
                ...
                for (LightType _item: light_) {
                    this.meshOrMaterialOrJoint.add(new LightType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addPair(final Iterable<? extends PairType> pair_) {
            if (pair_!= null) {
                ...
                for (PairType _item: pair_) {
                    this.meshOrMaterialOrJoint.add(new PairType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addEquality(final Iterable<? extends EqualityType> equality_) {
            if (equality_!= null) {
                ...
                for (EqualityType _item: equality_) {
                    this.meshOrMaterialOrJoint.add(new EqualityType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addTendon(final Iterable<? extends TendonType> tendon_) {
            if (tendon_!= null) {
                ...
                for (TendonType _item: tendon_) {
                    this.meshOrMaterialOrJoint.add(new TendonType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addGeneral(final Iterable<? extends GeneralType> general_) {
            if (general_!= null) {
                ...
                for (GeneralType _item: general_) {
                    this.meshOrMaterialOrJoint.add(new GeneralType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addMotor(final Iterable<? extends MotorType> motor_) {
            if (motor_!= null) {
                ...
                for (MotorType _item: motor_) {
                    this.meshOrMaterialOrJoint.add(new MotorType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addPosition(final Iterable<? extends PositionType> position_) {
            if (position_!= null) {
                ...
                for (PositionType _item: position_) {
                    this.meshOrMaterialOrJoint.add(new PositionType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addVelocity(final Iterable<? extends VelocityType> velocity_) {
            if (velocity_!= null) {
                ...
                for (VelocityType _item: velocity_) {
                    this.meshOrMaterialOrJoint.add(new VelocityType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addCylinder(final Iterable<? extends CylinderType> cylinder_) {
            if (cylinder_!= null) {
                ...
                for (CylinderType _item: cylinder_) {
                    this.meshOrMaterialOrJoint.add(new CylinderType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addMuscle(final Iterable<? extends MuscleType> muscle_) {
            if (muscle_!= null) {
                ...
                for (MuscleType _item: muscle_) {
                    this.meshOrMaterialOrJoint.add(new MuscleType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addDefault(final Iterable<? extends DefaultType> default_) {
            if (default_!= null) {
                ...
                for (DefaultType _item: default_) {
                    this.meshOrMaterialOrJoint.add(new DefaultType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType.Builder<_B> addInclude(final Iterable<? extends IncludeType> include_) {
            if (include_!= null) {
                ...
                for (IncludeType _item: include_) {
                    this.meshOrMaterialOrJoint.add(new IncludeType.Builder<DefaultType.Builder<_B>>(this, _item, false));
                }
            }
            return this;
        }
        ...
        public DefaultType build() {
            if (_storedValue == null) {
                ...
                return ((DefaultType) _storedValue);
            }
        }

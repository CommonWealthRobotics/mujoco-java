...
/**
 * <p>Java class for coneType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="coneType"&gt;
...
public enum ConeType {
    ...
    @XmlEnumValue("pyramidal")
    PYRAMIDAL("pyramidal"),
    @XmlEnumValue("elliptic")
    ELLIPTIC("elliptic");
    ...
    public static ConeType fromValue(String v) {
        for (ConeType c: ConeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }

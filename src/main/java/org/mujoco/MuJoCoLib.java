...
// #if defined _WIN32 || defined __CYGWIN__
  public static native @MemberGetter int MUJOCO_HELPER_DLL_IMPORT();
  public static final int MUJOCO_HELPER_DLL_IMPORT = MUJOCO_HELPER_DLL_IMPORT();
  public static native @MemberGetter int MUJOCO_HELPER_DLL_EXPORT();
  public static final int MUJOCO_HELPER_DLL_EXPORT = MUJOCO_HELPER_DLL_EXPORT();
...
public static native mjfCollision mjCOLLISIONFUNC(int i, int j); public static native void mjCOLLISIONFUNC(int i, int j, mjfCollision setter);
@MemberGetter public static native @Cast("mjfCollision*") @ByPtrPtr mjfCollision mjCOLLISIONFUNC();

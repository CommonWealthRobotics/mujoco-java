...
public class PairType implements Cloneable, Copyable, PartialCopyable
{
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final PairType _storedValue;
        private String name;
         ...
         */
        public PairType.Builder<_B> withName(final String name) {
            this.name = name;
            return this;
        }
         ...
         */
        public PairType.Builder<_B> withClazz(final String clazz) {
            this.clazz = clazz;
            return this;
        }
         ...
         */
        public PairType.Builder<_B> withGeom1(final String geom1) {
            this.geom1 = geom1;
            return this;
        }
         ...
         */
        public PairType.Builder<_B> withGeom2(final String geom2) {
            this.geom2 = geom2;
            return this;
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> name = null;
        private com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> clazz = null;
        private com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> geom1 = null;
        private com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> geom2 = null;
        ...
        public com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> name() {
            return ((this.name == null)?this.name = new com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>>(this._root, this, "name"):this.name);
        }

        public com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> clazz() {
            return ((this.clazz == null)?this.clazz = new com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>>(this._root, this, "clazz"):this.clazz);
        }

        public com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> geom1() {
            return ((this.geom1 == null)?this.geom1 = new com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>>(this._root, this, "geom1"):this.geom1);
        }

        public com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>> geom2() {
            return ((this.geom2 == null)?this.geom2 = new com.kscs.util.jaxb.Selector<TRoot, PairType.Selector<TRoot, TParent>>(this._root, this, "geom2"):this.geom2);
        }
